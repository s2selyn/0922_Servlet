...
public class MemberService {
	...
	public Member login(Member member) {
		...
		// 세션객체 만들거고
		// 근데 DAO에서 세션만들어도 상관없지만 굳이 여기서 만드는 이유는 여기서 트랜젝션 처리 하려고 그런거임
		// 트랜젝션 처리 할생각 없으면 DAO에서 세션생성가능
		// 게시글 작성한다면 insert, 테이블 두개쓸거임, 게시글내용 + 파일내용
		// 한 기능을 위해 insert 두번 수행할거임, 그러면 게시글작성 성공해도 첨부파일 실패하면 게시글도 취소할거고, 게시글 실패하면 파일첨부도 실패처리, 두개의 트랜젝션을 하나로 묶어서 처리할거라서
		// ??? 트랜젝션 처리?
